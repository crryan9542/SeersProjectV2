...
private boolean load() throws IOException{
    ...
    @Override
    public Prophecy[] getProphecies() throws IOException {
    ...
    @Override
    public Prophecy[] findProphecies(String name) throws IOException {
        synchronized (prophecies) {
    ...
    @Override
    public Prophecy getProphecy(int id) throws IOException {
        synchronized (prophecies) {
